...
You can clone and build Kiuatan directly from GitHub (you must have [Pony-Stable](https://github.com/ponylang/pony-stable) in your `PATH`):
...
To use Kiuatan in a project without [Pony-Stable](https://github.com/ponylang/pony-stable) you will need to add `kiuatan/kiuatan` to your `PONYPATH` environment variable.
